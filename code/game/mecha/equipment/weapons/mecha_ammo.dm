...
/obj/item/mecha_ammo/proc/update_names()
	if(!rounds)
		name = "empty ammo box"
...
/obj/item/mecha_ammo/tank_shell/update_names() // i hate the fact that i think this is the only way to do this, what the fuck
	if(!rounds)
		qdel(src)
