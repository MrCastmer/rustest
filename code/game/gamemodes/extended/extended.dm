...
/datum/game_mode/extended/announced/send_intercept(report = 0)
	priority_announce("Мы провели сканирование сектора и не нашли никакой вражеской инфраструктуры. Приятного вам исследования!", "Security Report", 'sound/ai/commandreport.ogg')
