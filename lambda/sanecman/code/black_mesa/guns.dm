...
//	auto_fire = FALSE //Удалить как пойму чё это
	mag_type = /obj/item/ammo_box/magazine/recharge/marksman
	force = 15
	weapon_weight = WEAPON_HEAVY
	fire_delay = 4 SECONDS
	fire_sound = 'lambda/sanecman/sound/black_mesa/guns/chaingun_fire.ogg'
...
/obj/item/gun/ballistic/automatic/mp5
	...
	icon = 'lambda/sanecman/icons/black_mesa/gunsgalore_guns40x32.dmi'
	lefthand_file = 'lambda/sanecman/icons/black_mesa/gunsgalore_lefthand.dmi'
	righthand_file ='lambda/sanecman/icons/black_mesa/gunsgalore_righthand.dmi'
	icon_state = "mp5"
	inhand_icon_state = "mp5"
//	selector_switch_icon = TRUE //Удалить как пойму чё это
	...
	spread = 2.5
	mag_display = TRUE
	load_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_magin.ogg'
	load_empty_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_magin.ogg'
	rack_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_cock.ogg'
	lock_back_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_boltback.ogg'
	eject_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_magout.ogg'
	eject_empty_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_magout.ogg'
	bolt_drop_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_boltforward.ogg'
	fire_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_fire.ogg'
	suppressed_sound = 'lambda/sanecman/sound/black_mesa/guns/mp5_fire_suppressed.ogg'
...
/obj/item/ammo_box/magazine/mp5
	...
	icon = 'lambda/sanecman/icons/black_mesa/gunsgalore_items.dmi'
	icon_state = "mp5"
