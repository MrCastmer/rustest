...
/obj/item/clothing/head/helmet/space/hev_suit
	...
	icon = 'lambda/sanecman/icons/black_mesa/hats.dmi'
	mob_overlay_icon = 'lambda/sanecman/icons/black_mesa/head.dmi'
	icon_state = "hev"
	inhand_icon_state = "sec_helm"
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 40, "fire" = 40, "acid" = 40, "magic" = 10)
...
/obj/item/clothing/suit/space/hev_suit
	...
	icon = 'lambda/sanecman/icons/black_mesa/suits.dmi'
	mob_overlay_icon = 'lambda/sanecman/icons/black_mesa/suit.dmi'
	icon_state = "hev"
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 40, "fire" = 40, "acid" = 40, "magic" = 10) //This is gordons suit, of course it's strong.
	allowed = list(/obj/item/gun, /obj/item/ammo_box,/obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/melee/transforming/energy/sword, /obj/item/restraints/handcuffs, /obj/item/tank/internals)
	var/obj/item/stock_parts/cell/cell = /obj/item/stock_parts/cell/hyper
	slowdown = 0 //I am not gimping doctor freeman
	actions_types = list(/datum/action/item_action/hev_toggle, /datum/action/item_action/hev_toggle_notifs, /datum/action/item_action/toggle_helmet)
	resistance_flags = LAVA_PROOF|FIRE_PROOF|UNACIDABLE|ACID_PROOF|INDESTRUCTIBLE|FREEZE_PROOF
	...
	///Lots of sound vars.
	var/activation_song = 'lambda/sanecman/sound/black_mesa/hev/anomalous_materials.ogg'

	var/logon_sound = 'lambda/sanecman/sound/black_mesa/hev/01_hev_logon.ogg'
	var/armor_sound = 'lambda/sanecman/sound/black_mesa/hev/02_powerarmor_on.ogg'
	var/atmospherics_sound = 'lambda/sanecman/sound/black_mesa/hev/03_atmospherics_on.ogg'
	var/vitalsigns_sound = 'lambda/sanecman/sound/black_mesa/hev/04_vitalsigns_on.ogg'
	var/automedic_sound = 'lambda/sanecman/sound/black_mesa/hev/05_automedic_on.ogg'
	var/weaponselect_sound = 'lambda/sanecman/sound/black_mesa/hev/06_weaponselect_on.ogg'
	var/munitions_sound = 'lambda/sanecman/sound/black_mesa/hev/07_munitionview_on.ogg'
	var/communications_sound = 'lambda/sanecman/sound/black_mesa/hev/08_communications_on.ogg'
	var/safe_day_sound = 'lambda/sanecman/sound/black_mesa/hev/09_safe_day.ogg'

	var/batt_50_sound = 'lambda/sanecman/sound/black_mesa/hev/power_level_is_fifty.ogg'
	var/batt_40_sound = 'lambda/sanecman/sound/black_mesa/hev/power_level_is_fourty.ogg'
	var/batt_30_sound = 'lambda/sanecman/sound/black_mesa/hev/power_level_is_thirty.ogg'
	var/batt_20_sound = 'lambda/sanecman/sound/black_mesa/hev/power_level_is_twenty.ogg'
	var/batt_10_sound = 'lambda/sanecman/sound/black_mesa/hev/power_level_is_ten.ogg'

	var/near_death_sound = 'lambda/sanecman/sound/black_mesa/hev/near_death.ogg'
	var/health_critical_sound = 'lambda/sanecman/sound/black_mesa/hev/health_critical.ogg'
	var/health_dropping_sound = 'lambda/sanecman/sound/black_mesa/hev/health_dropping2.ogg'

	var/blood_loss_sound = 'lambda/sanecman/sound/black_mesa/hev/blood_loss.ogg'
	var/blood_toxins_sound = 'lambda/sanecman/sound/black_mesa/hev/blood_toxins.ogg'
	var/biohazard_sound = 'lambda/sanecman/sound/black_mesa/hev/biohazard_detected.ogg'
	var/chemical_sound = 'lambda/sanecman/sound/black_mesa/hev/chemical_detected.ogg'

	var/minor_fracture_sound = 'lambda/sanecman/sound/black_mesa/hev/minor_fracture.ogg'
	var/major_fracture_sound = 'lambda/sanecman/sound/black_mesa/hev/major_fracture.ogg'
	var/minor_lacerations_sound = 'lambda/sanecman/sound/black_mesa/hev/minor_lacerations.ogg'
	var/major_lacerations_sound = 'lambda/sanecman/sound/black_mesa/hev/major_lacerations.ogg'

	var/morphine_sound = 'lambda/sanecman/sound/black_mesa/hev/morphine_shot.ogg'
	var/wound_sound = 'lambda/sanecman/sound/black_mesa/hev/wound_sterilized.ogg'
	var/antitoxin_sound = 'lambda/sanecman/sound/black_mesa/hev/antitoxin_shot.ogg'
	var/antidote_sound = 'lambda/sanecman/sound/black_mesa/hev/antidote_shot.ogg'
...
/datum/action/item_action/hev_toggle
	...
	button_icon = 'lambda/sanecman/icons/black_mesa/toggles.dmi'
	background_icon_state = "bg_hl"
	icon_icon = 'lambda/sanecman/icons/black_mesa/toggles.dmi'
...
/datum/action/item_action/hev_toggle_notifs/Trigger(trigger_flags)
	...
	playsound(my_suit, 'lambda/sanecman/sound/black_mesa/hev/blip.ogg', 50)
...
/obj/item/clothing/suit/space/hev_suit/proc/stat_changed(datum/source, new_stat)
	SIGNAL_HANDLER
	if(new_stat == DEAD)
		playsound(src, 'lambda/sanecman/sound/black_mesa/hev/flatline.ogg', 40)
...
/obj/item/clothing/suit/space/hev_suit/proc/medical_systems()
	RegisterSignal(current_user, COMSIG_CARBON_GAIN_WOUND, PROC_REF(process_say))
...
/obj/item/clothing/suit/space/hev_suit/process(delta_time)
	...
	var/obj/item/bodypart/B = current_user.bodyparts
...
/obj/item/clothing/suit/space/hev_suit/proc/process_say(maxHealth, health)
	SIGNAL_HANDLER
...
// Это такие костыли я ебал
// Что тут было: прок смотрел wound на персонаже и высирал звук
// Что сейчас: прок ориентируется на хп у куклы и выдаёт фразу или не выдаёт
...
/obj/item/clothing/head/helmet/space/hev_suit/pcv
	...
	inhand_icon_state = "sec_helm"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 20, "fire" = 20, "acid" = 20, "magic" = 10)
	flags_inv = HIDEHAIR
	obj_flags = NO_MAT_REDEMPTION
...
/obj/item/clothing/suit/space/hev_suit/pcv
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 20, "fire" = 20, "acid" = 20, "magic" = 10) //This is muhreens suit, of course it's mildly strong and balanced for PvP.
	flags_inv = null
	allowed = list(/obj/item/gun, /obj/item/ammo_box,/obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/melee/transforming/energy/sword, /obj/item/restraints/handcuffs, /obj/item/tank/internals)
	...
	activation_song = 'lambda/sanecman/sound/black_mesa/pcv/planet.ogg'

	logon_sound = 'lambda/sanecman/sound/black_mesa/pcv/01_pcv_logon.ogg'
	armor_sound = 'lambda/sanecman/sound/black_mesa/pcv/02_powerarmor_on.ogg'
	atmospherics_sound = 'lambda/sanecman/sound/black_mesa/pcv/03_atmospherics_on.ogg'
	vitalsigns_sound = 'lambda/sanecman/sound/black_mesa/pcv/04_vitalsigns_on.ogg'
	automedic_sound = 'lambda/sanecman/sound/black_mesa/pcv/05_automedic_on.ogg'
	weaponselect_sound = 'lambda/sanecman/sound/black_mesa/pcv/06_weaponselect_on.ogg'
	munitions_sound = 'lambda/sanecman/sound/black_mesa/pcv/07_munitionview_on.ogg'
	communications_sound = 'lambda/sanecman/sound/black_mesa/pcv/08_communications_on.ogg'
	safe_day_sound = 'lambda/sanecman/sound/black_mesa/pcv/09_safe_day.ogg'

	batt_50_sound = 'lambda/sanecman/sound/black_mesa/pcv/power_level_is_fifty.ogg'
	batt_40_sound = 'lambda/sanecman/sound/black_mesa/pcv/power_level_is_fourty.ogg'
	batt_30_sound = 'lambda/sanecman/sound/black_mesa/pcv/power_level_is_thirty.ogg'
	batt_20_sound = 'lambda/sanecman/sound/black_mesa/pcv/power_level_is_twenty.ogg'
	batt_10_sound = 'lambda/sanecman/sound/black_mesa/pcv/power_level_is_ten.ogg'

	near_death_sound = 'lambda/sanecman/sound/black_mesa/pcv/near_death.ogg'
	health_critical_sound = 'lambda/sanecman/sound/black_mesa/pcv/health_critical.ogg'
	health_dropping_sound = 'lambda/sanecman/sound/black_mesa/pcv/health_dropping2.ogg'

	blood_loss_sound = 'lambda/sanecman/sound/black_mesa/pcv/blood_loss.ogg'
	blood_toxins_sound = 'lambda/sanecman/sound/black_mesa/pcv/blood_toxins.ogg'
	biohazard_sound = 'lambda/sanecman/sound/black_mesa/pcv/biohazard_detected.ogg'
	chemical_sound = 'lambda/sanecman/sound/black_mesa/pcv/chemical_detected.ogg'

	minor_fracture_sound = 'lambda/sanecman/sound/black_mesa/pcv/minor_fracture.ogg'
	major_fracture_sound = 'lambda/sanecman/sound/black_mesa/pcv/major_fracture.ogg'
	minor_lacerations_sound = 'lambda/sanecman/sound/black_mesa/pcv/minor_lacerations.ogg'
	major_lacerations_sound = 'lambda/sanecman/sound/black_mesa/pcv/major_lacerations.ogg'

	morphine_sound = 'lambda/sanecman/sound/black_mesa/pcv/morphine_shot.ogg'
	wound_sound = 'lambda/sanecman/sound/black_mesa/pcv/wound_sterilized.ogg'
	antitoxin_sound = 'lambda/sanecman/sound/black_mesa/pcv/antitoxin_shot.ogg'
	antidote_sound = 'lambda/sanecman/sound/black_mesa/pcv/antidote_shot.ogg'
