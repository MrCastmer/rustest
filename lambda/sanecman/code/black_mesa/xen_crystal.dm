...
/obj/structure/xen_crystal/Initialize(mapload)
	. = ..()
	var/color_to_set = pick(COLOR_VIBRANT_LIME, COLOR_VIVID_YELLOW, COLOR_BLUSH_PINK, LIGHT_COLOR_ELECTRIC_GREEN)
	color = color_to_set
...
/obj/item/grenade/xen_crystal/prime(mob/user)
