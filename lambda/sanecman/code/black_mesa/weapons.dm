/obj/item/crowbar/freeman
	name = "монтировка"
	desc = "Ржавый лом."
	icon = 'lambda/sanecman/icons/black_mesa/freeman.dmi'
	icon_state = "crowbar"
	force = 35
	throwforce = 45
	toolspeed = 0.1
	hitsound = 'lambda/sanecman/sound/black_mesa/crowbar2.ogg'
	mob_throw_hit_sound = 'lambda/sanecman/sound/black_mesa/crowbar2.ogg'
	force_opens = TRUE
...
/obj/item/ballistic_broken
	...
	icon = 'lambda/sanecman/icons/black_mesa/ballistic.dmi'
