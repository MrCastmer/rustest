...
// Как закончишь с нужным почини хаундаев
/mob/living/simple_animal/hostile/blackmesa/xen/houndeye
	...
	alert_sounds = list(
		'lambda/sanecman/sound/black_mesa/mobs/houndeye/he_alert1.ogg',
		'lambda/sanecman/sound/black_mesa/mobs/houndeye/he_alert2.ogg',
		'lambda/sanecman/sound/black_mesa/mobs/houndeye/he_alert3.ogg',
		'lambda/sanecman/sound/black_mesa/mobs/houndeye/he_alert4.ogg',
		'lambda/sanecman/sound/black_mesa/mobs/houndeye/he_alert5.ogg'
	)
	/// Charging ability
