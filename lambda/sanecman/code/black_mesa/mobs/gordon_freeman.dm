...
/mob/living/simple_animal/hostile/blackmesa/xen/headcrab_zombie/gordon_freeman
	...
	wander = FALSE
	attack_sound = 'lambda/sanecman/sound/black_mesa/crowbar2.ogg'
...
/datum/outfit/gordon_freeman
	...
	id = /obj/item/card/id/gordon_freeman
...
/obj/item/card/id/gordon_freeman
	name = "карта учёного"
	assignment = "Физик-теоретик"

/obj/item/card/id/gordon_freeman/Initialize(mapload)
	. = ..()
