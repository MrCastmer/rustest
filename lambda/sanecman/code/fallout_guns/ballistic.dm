...
/obj/item/gun/ballistic/fallout
	...
	icon = 'lambda/sanecman/icons/fallout/ballistics.dmi'
	lefthand_file = 'lambda/sanecman/icons/fallout/guns_lefthand.dmi'
	righthand_file = 'lambda/sanecman/icons/fallout/guns_righthand.dmi'
