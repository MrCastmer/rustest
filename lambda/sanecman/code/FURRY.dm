/mob/living/simple_animal/xaxi
	name = "oma-oma"
	desc = "Прикольно."
	icon = 'lambda/sanecman/icons/dz-031.dmi'
	icon_state = "taj"
	icon_living = "taj"
	maxHealth = INFINITY
	health = INFINITY
...
/mob/living/simple_animal/xaxi/Login()
	...
	SEND_SOUND(src, sound('lambda/sanecman/sound/xeno.ogg', repeat = TRUE, wait = 0, volume = 50))
	roleplay_progress = 0
...
/mob/living/simple_animal/xaxi/Life()
	...
	if(prob(5))
		blur_eyes(1)
		SEND_SOUND(client, sound("lambda/sanecman/sound/halun/halun[rand(1,19)].ogg"))
...
/mob/living/simple_animal/xaxi/show_message(msg, type, alt_msg, alt_type, avoid_highlighting)
	...
	if(prob(50))
		SEND_SOUND(src, sound("lambda/sanecman/sound/halun/halun[rand(1,19)].ogg"))
